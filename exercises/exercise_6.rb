...
@store1.employees.create(first_name: "George", last_name: "Costanza", hourly_rate: 4)
@store1.employees.create(first_name: "Gerald", last_name: "Butts", hourly_rate: 43)
@store1.employees.create(first_name: "Caroline", last_name: "Samuels", hourly_rate: 32)
@store1.employees.create(first_name: "Lindy", last_name: "Francis", hourly_rate: 21)
